...
<div class="card card-item">
    ...
    <form action="<?php echo e(route('stripe_order')); ?>" method="post" id="payment-form">
        <?php echo csrf_field(); ?>
        <div class="form-row">
...
</html><?php /**PATH C:\xampp\htdocs\lms\lms\resources\views/frontend/payment/stripe.blade.php ENDPATH**/ ?>