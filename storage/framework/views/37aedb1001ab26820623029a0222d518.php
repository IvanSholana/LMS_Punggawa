...
<?php echo e($course->course_name); ?> | Easy Learning
...
<section class="breadcrumb-area pt-50px pb-50px bg-white pattern-bg">
        ...
        <div class="col-lg-8 mr-auto">
            <div class="breadcrumb-content">
                <ul class="generic-list-item generic-list-item-arrow d-flex flex-wrap align-items-center">
                    ...
                    <li><a href="#"><?php echo e($course['category']['category_name']); ?></a></li>
                    <li><a href="#"><?php echo e($course['subcategory']['subcategory_name']); ?></a></li>
                </ul>
                <div class="section-heading">
                    <h2 class="section__title"><?php echo e($course->course_name); ?></h2>
                    <p class="section__desc pt-2 lh-30"><?php echo e($course->course_title); ?></p>
   ...
   ?>                 
                    ...
                    <div class="rating-wrap d-flex flex-wrap align-items-center">
                        ...
                        <span class="rating-total pl-1">(<?php echo e(count($reviewcount)); ?> ratings)</span>
    <?php
        $enrollmentCount = App\Models\Order::where('course_id',$course->id)->count();
    ?>

                        <span class="student-total pl-2"><?php echo e(number_format($enrollmentCount)); ?> students</span>
                    </div>
                </div><!-- end d-flex -->
                <p class="pt-2 pb-1">Created by <a href="teacher-detail.html" class="text-color hover-underline"><?php echo e($course['user']['name']); ?></a></p>
                <div class="d-flex flex-wrap align-items-center">
                    <p class="pr-3 d-flex align-items-center">
                        ...
                        Last updated <?php echo e($course->created_at->format('M d Y')); ?>
   ...
   <li><i class="la la-check mr-1 text-black"></i>  <?php echo e($goal->goal_name); ?> </li>
                   ...
                   <div class="course-overview-card">
                       ...
                       <ul class="generic-list-item generic-list-item-bullet fs-15">
                           <li> <?php echo e($course->prerequisites); ?> </li>
                    ...
                    <div class="course-overview-card border border-gray p-4 rounded">
                       ...
                       <p class="fs-15 pb-1">Get your team access to Aduca's top 5,000+ courses</p>
                        <div class="pb-3">
                            <img width="85" class="mr-3" src="<?php echo e(asset('frontend/images/sponsor-img.png')); ?>" alt="company logo">
                            <img width="80" class="mr-3" src="<?php echo e(asset('frontend/images/sponsor-img2.png')); ?>" alt="company logo">
                            <img width="80" class="mr-3" src="<?php echo e(asset('frontend/images/sponsor-img3.png')); ?>" alt="company logo">
                            <img width="70" class="mr-3" src="<?php echo e(asset('frontend/images/sponsor-img4.png')); ?>" alt="company logo">
                        </div>
                   ...
                   <div class="course-overview-card">
                       ...
                       <p class="fs-15 pb-2"> <?php echo $course->description; ?> </p>


                       <div class="collapse" id="collapseMore">
                          
                        <h4 class="fs-20 font-weight-semi-bold py-2">Who this course is for:</h4>
                        <p class="fs-15 pb-2"> <?php echo e($course->prerequisites); ?> </p>
                   ...
                   <div class="course-overview-card">
                       <div class="curriculum-header d-flex align-items-center justify-content-between pb-4">
                           ...
                           <div class="curriculum-duration fs-15">
                               <span class="curriculum-total__text mr-2"><strong class="text-black font-weight-semi-bold">Total:</strong> <?php echo e(count($lecture)); ?> lectures</span>
                               <span class="curriculum-total__hours"><strong class="text-black font-weight-semi-bold">Total hours:</strong> <?php echo e($course->duration); ?></span>
                           </div>
                       </div>
    ...
    <div class="card">
            <div class="card-header" id="heading<?php echo e($sec->id); ?>">
                <button class="btn btn-link d-flex align-items-center justify-content-between" data-toggle="collapse" data-target="#collapse<?php echo e($sec->id); ?>" aria-expanded="true" aria-controls="collapse<?php echo e($sec->id); ?>">
                    <i class="la la-plus"></i>
                    <i class="la la-minus"></i>
                    <?php echo e($sec->section_title); ?>

                    <span class="fs-15 text-gray font-weight-medium">
                        <?php echo e(count($lecture)); ?> lectures</span>
                </button>
            </div><!-- end card-header -->
            <div id="collapse<?php echo e($sec->id); ?>" class="collapse " aria-labelledby="heading<?php echo e($sec->id); ?>" data-parent="#accordion">
                <div class="card-body">
                    <ul class="generic-list-item">
                       <?php $__currentLoopData = $lecture; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $lect): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?> 
                        <li>
                            <div class="d-flex align-items-center justify-content-between">
                                <span>
                                    <i class="la la-play-circle mr-1"></i>
                                   <?php echo e($lect->lecture_title); ?>
            ...
            <div class="media media-card">
                <div class="instructor-img">
                    <a href="teacher-detail.html" class="media-img d-block">
                        <img class="lazy" src="<?php echo e((!empty($course->user->photo)) ? url('upload/instructor_images/'.$course->user->photo) : url('upload/no_image.jpg')); ?>" data-src="images/small-avatar-1.jpg" alt="Avatar image">
                    </a>
                    <ul class="generic-list-item pt-3">
                        ...
                        <li><i class="la la-play-circle-o mr-2 text-color-3"></i> <?php echo e(count($instructorCourses)); ?> Courses</li>
                        <li><a href="teacher-detail.html">View all Courses</a></li>
                    </ul>
                </div><!-- end instructor-img -->
                <div class="media-body">
                    <h5><a href="teacher-detail.html"><?php echo e($course['user']['name']); ?></a></h5>
                    <span class="d-block lh-18 pt-2 pb-3">Joined <?php echo e(Carbon\Carbon::parse($course->user->created_at)->diffForHumans()); ?></span>
                    <p class="text-black lh-18 pb-3"><?php echo e($course['user']['email']); ?></p>
                       ...
                       <div class="feedback-wrap">
                           <div class="media media-card align-items-center">
                               <div class="review-rating-summary">
                                    <span class="stats-average__count"><?php echo e(round($avarage,1)); ?></span>
                                   <div class="rating-wrap pt-1">
                                       ...
                                       <span class="rating-total d-block">(<?php echo e(count($reviewcount)); ?>)</span>
    ...
    <div class="media-body">
        ...
        <?php $__currentLoopData = $percentages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $ratingInfo): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            
        <div class="review-bars d-flex align-items-center mb-2">
            <div class="review-bars__text"><?php echo e($ratingInfo['rating']); ?> stars</div>
            <div class="review-bars__fill">
                <div class="skillbar-box">
   <div class="skillbar" data-percent="<?php echo e($ratingInfo['percent']); ?>%">
                        <div class="skillbar-bar bg-3" style="width: <?php echo e($ratingInfo['percent']); ?>%;" ></div>
                    </div> <!-- End Skill Bar -->
                </div>
            </div><!-- end review-bars__fill -->
            <div class="review-bars__percent"><?php echo e(number_format($ratingInfo['percent'], 2)); ?>%</div>
        </div><!-- end review-bars -->
   ...
   ?>
    ...
    <div class="media media-card border-bottom border-bottom-gray pb-4 mb-4">
        <div class="media-img mr-4 rounded-full">
            <img class="rounded-full lazy" src="<?php echo e((!empty($item->user->photo)) ? url('upload/user_images/'.$item->user->photo) : url('upload/no_image.jpg')); ?>" data-src="images/small-avatar-1.jpg" alt="User image">
        </div>
        <div class="media-body">
            <div class="d-flex flex-wrap align-items-center justify-content-between pb-1">
                <h5><?php echo e($item->user->name); ?></h5>
                <div class="review-stars">
            ...
            <span class="d-block lh-18 pb-2"><?php echo e(Carbon\Carbon::parse($item->created_at)->diffForHumans()); ?></span>
            <p class="pb-2"><?php echo e($item->comment); ?></p>
...
<p><b> For Add Course Review. You need to login first <a href="<?php echo e(route('login')); ?>"> Login Here</a> </b> </p>
               <?php else: ?> 
                  
                   <div class="course-overview-card pt-4">
                       <h3 class="fs-24 font-weight-semi-bold pb-4">Add a Review</h3>
                       
        <form method="post" action="<?php echo e(route('store.review')); ?>" class="row">
            <?php echo csrf_field(); ?>
        ...
        <div class="leave-rating-wrap pb-4">
            ...
            <input type="hidden" name="instructor_id" value="<?php echo e($course->instructor_id); ?>">
                        ...
                        <div class="card-body">
                            <div class="preview-course-video">
                                <a href="javascript:void(0)" data-toggle="modal" data-target="#previewModal">
                                    <img src="<?php echo e(asset($course->course_image)); ?>" data-src="<?php echo e(asset($course->course_image)); ?>" alt="course-img" class="w-100 rounded lazy">
   ...
   ?>            
         ...
         <p class="d-flex align-items-center pb-2">
            ...
            <span class="fs-35 font-weight-semi-bold text-black">$<?php echo e($course->selling_price); ?></span>
            <?php else: ?>
            <span class="fs-35 font-weight-semi-bold text-black">$<?php echo e($course->discount_price); ?></span>
            <span class="before-price mx-1">$<?php echo e($course->selling_price); ?></span>
            <?php endif; ?>
            
            
            <span class="price-discount"><?php echo e(round($discount)); ?>% off</span>
        </p>
                                <p class="preview-price-discount-text pb-35px">
                                    <span class="text-color-3">4 days</span> left at this price!
                                </p>
<div class="buy-course-btn-box">
    <button type="submit" class="btn theme-btn w-100 mb-2" onclick="addToCart(<?php echo e($course->id); ?>, '<?php echo e($course->course_name); ?>', '<?php echo e($course->instructor_id); ?>', '<?php echo e($course->course_name_slug); ?>' )" ><i class="la la-shopping-cart fs-18 mr-1"></i> Add to cart</button>

    <button type="button" class="btn theme-btn w-100 theme-btn-white mb-2"  onclick="buyCourse(<?php echo e($course->id); ?>, '<?php echo e($course->course_name); ?>', '<?php echo e($course->instructor_id); ?>', '<?php echo e($course->course_name_slug); ?>' )"><i class="la la-shopping-bag mr-1"></i> Buy this course</button>
    ...
    <div class="input-group mb-2" id="couponField">
        ...
        <div class="input-group-append">
            <input type="hidden" id="course_id" name="course_id" value="<?php echo e($course->id); ?>">
            <input type="hidden" id="instrutor_id" name="instrutor_id" value="<?php echo e($course->instructor_id); ?>">
      <a type="submit" onclick="applyInsCoupon()" class="btn theme-btn">Apply Code</a>      
            ...
            <ul class="generic-list-item pb-3">
                <li><i class="la la-play-circle-o mr-2 text-color"></i><?php echo e($course->duration); ?> hours on-demand video</li>
                <li><i class="la la-file mr-2 text-color"></i><?php echo e($course->resources); ?> articles</li>
    ...
    <ul class="generic-list-item generic-list-item-flash">
        <li class="d-flex align-items-center justify-content-between"><span><i class="la la-clock mr-2 text-color"></i>Duration</span> <?php echo e($course->duration); ?> hours</li>
        
        <li class="d-flex align-items-center justify-content-between"><span><i class="la la-file-text-o mr-2 text-color"></i>Resources</span> <?php echo e($course->resources); ?></li>
        ...
        <li class="d-flex align-items-center justify-content-between"><span><i class="la la-lightbulb mr-2 text-color"></i>Skill level</span> <?php echo e($course->label); ?></li>
        ...
        <li class="d-flex align-items-center justify-content-between"><span><i class="la la-certificate mr-2 text-color"></i>Certificate</span> <?php echo e($course->certificate); ?></li>
    </ul>
                        </div>
                    </div><!-- end card -->
                    <div class="card card-item">
                        <div class="card-body">
                            ...
                            <ul class="generic-list-item">
                               <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cat): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <li><a href="<?php echo e(url('category/'.$cat->id.'/'.$cat->category_slug)); ?>"><?php echo e($cat->category_name); ?></a></li> 
                               <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?> 
        ...
        <div class="media media-card border-bottom border-bottom-gray pb-4 mb-4">
            <a href="course-details.html" class="media-img">
                <img class="mr-3 lazy" src="<?php echo e(asset($related->course_image)); ?>" data-src="<?php echo e(asset($related->course_image)); ?>" alt="Related course image">
            </a>
            <div class="media-body">
                <h5 class="fs-15"><a href="course-details.html"> <?php echo e($related->course_name); ?></a></h5>
                <span class="d-block lh-18 py-1 fs-14"><?php echo e($related['user']['name']); ?></span>

                <?php if($related->discount_price == NULL): ?>
                <p class="text-black font-weight-semi-bold lh-18 fs-15">$<?php echo e($related->selling_price); ?>  </p>
                <?php else: ?>
                <p class="text-black font-weight-semi-bold lh-18 fs-15">$<?php echo e($related->discount_price); ?> <span class="before-price fs-14">$<?php echo e($related->selling_price); ?></span></p>
                <?php endif; ?>
...
<section class="related-course-area bg-gray pt-60px pb-60px">
    <div class="container">
        <div class="related-course-wrap">
            <h3 class="fs-28 font-weight-semi-bold pb-35px">More Courses by <a href="teacher-detail.html" class="text-color hover-underline"><?php echo e($course['user']['name']); ?></a></h3>
            <div class="view-more-carousel-2 owl-action-styled">
                
                <?php $__currentLoopData = $instructorCourses; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $inscourse): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            ...
            ?>
                ...
                <div class="card card-item">
                    <div class="card-image">
                        <a href="<?php echo e(url('course/details/'.$inscourse->id.'/'.$inscourse->course_name_slug)); ?>" class="d-block">
                            <img class="card-img-top" src="<?php echo e(asset($inscourse->course_image)); ?>" alt="Card image cap">
                        </a>
                        <div class="course-badge-labels">

                            <?php if($inscourse->bestseller == 1): ?>
                            <div class="course-badge">Bestseller</div>
                            <?php else: ?>
                            <?php endif; ?>

                            <?php if($inscourse->discount_price == NULL): ?>
                    ...
                    <div class="card-body">
                        <h6 class="ribbon ribbon-blue-bg fs-14 mb-3"><?php echo e($inscourse->label); ?></h6>
                        <h5 class="card-title"><a href="<?php echo e(url('course/details/'.$inscourse->id.'/'.$inscourse->course_name_slug)); ?>"><?php echo e($inscourse->course_name); ?></a></h5>
                        <p class="card-text"><a href="teacher-detail.html"><?php echo e($inscourse['user']['name']); ?></a></p>
                    ...
                    <?php if($inscourse->discount_price == NULL): ?>
                    <p class="card-price text-black font-weight-bold">$<?php echo e($inscourse->selling_price); ?>  </p>
                    <?php else: ?>
                    <p class="card-price text-black font-weight-bold">$<?php echo e($inscourse->discount_price); ?> <span class="before-price font-weight-medium">$<?php echo e($inscourse->selling_price); ?></span></p> 
                    <?php endif; ?>
            ...
            <div class="modal-body">
                <div class="copy-to-clipboard">
                    ...
                    <div class="input-group">
                        <input type="text" class="form-control form--control copy-input pl-3" value="http://127.0.0.1:8000/<?php echo e(Request::path()); ?> ">
                        <div class="input-group-append">
        ...
        <div class="modal-content">
            <div class="modal-header border-bottom-gray">
                <div class="pr-2">
                    ...
                    <h5 class="modal-title fs-19 font-weight-semi-bold lh-24" id="previewModalTitle"><?php echo e($course->course_name); ?></h5>
                </div>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true" class="la la-times"></span>
                </button>
            ...
            <div class="modal-body">
                <video controls crossorigin playsinline poster="<?php echo e(asset($course->course_image)); ?>" id="player">
                    <!-- Video files -->
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('frontend.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\lms\lms\resources\views/frontend/course/course_details.blade.php ENDPATH**/ ?>