...
<div class="container-fluid">
    ...
    <div class="dashboard-cards mb-5">
       ...
       <?php $__currentLoopData = $mycourse; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <div class="card card-item card-item-list-layout">
            <div class="card-image">
                <a href="<?php echo e(route('course.view',$item->course_id)); ?>" class="d-block">
                    <img class="card-img-top" src="<?php echo e(asset($item->course->course_image)); ?>" alt="Card image cap">
                </a>
                
            </div><!-- end card-image -->
            <div class="card-body">
                <h6 class="ribbon ribbon-blue-bg fs-14 mb-3"><?php echo e($item->course->label); ?></h6>
                <h5 class="card-title"><a href="<?php echo e(route('course.view',$item->course_id)); ?>"><?php echo e($item->course->course_name); ?></a></h5>
                <p class="card-text"><a href="teacher-detail.html"><?php echo e($item->course->user->name); ?></a></p>
                ...
                <ul class="card-duration d-flex align-items-center fs-15 pb-2">
                    ...
                    <li class="mr-2">
                        ...
                        <span><?php echo e($item->course->duration); ?> hours </span>
                    </li>
                    <li class="mr-2">
                ...
                <div class="d-flex justify-content-between align-items-center">
                    <p class="card-price text-black font-weight-bold">$<?php echo e($item->course->selling_price); ?></p>
...
<?php echo $__env->make('frontend.dashboard.user_dashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\lms\lms\resources\views/frontend/mycourse/my_all_course.blade.php ENDPATH**/ ?>