                ...
                <div class="col-lg-6">
                    <div class="header-widget">
                        <ul class="generic-list-item d-flex flex-wrap align-items-center fs-14">
                            <li class="d-flex align-items-center pr-3 mr-3 border-right border-right-gray"><i class="la la-phone mr-1"></i><a href="tel:00123456789"> <?php echo e($setting->phone); ?></a></li>
                            <li class="d-flex align-items-center"><i class="la la-envelope-o mr-1"></i><a href="mailto:<?php echo e($setting->email); ?>"><?php echo e($setting->email); ?></a></li>
                        </ul>
        ...
        <div class="container-fluid">
            <div class="main-menu-content">
                ...
                <div class="row align-items-center">
                    <div class="col-lg-2">
                        <div class="logo-box">
                            <a href="<?php echo e(url('/')); ?>" class="logo"><img src="<?php echo e(asset($setting->logo)); ?>" alt="logo"></a>
...
<div class="col-lg-10">
    <div class="menu-wrapper">
        ...
        ?>                
                        <li>
                            <a href="<?php echo e(url('category/'.$cat->id.'/'.$cat->category_slug)); ?>"><?php echo e($cat->category_name); ?><i class="la la-angle-right"></i></a>
                            <ul class="sub-menu">
                                ...
                                <li><a href="<?php echo e(url('subcategory/'.$subcat->id.'/'.$subcat->subcategory_slug)); ?>"><?php echo e($subcat->subcategory_name); ?></a></li> 
                ...
                <li>
                    ...
                    <ul class="cart-dropdown-menu">
                       ...
                       <br><br>
                        ...
                        <li>
                            <a href="<?php echo e(route('mycart')); ?>" class="btn theme-btn w-100">Go to cart <i class="la la-arrow-right icon ml-1"></i></a>
                        </li>
                    </ul>
                </li>
            </ul>
...
</header><!-- end header-menu-area --><?php /**PATH C:\xampp\htdocs\lms\lms\resources\views/frontend/body/header.blade.php ENDPATH**/ ?>