        ...
        <div class="card card-item">
            <div class="card-image">
                <a href="blog-single.html" class="d-block">
                    <img class="card-img-top lazy" src="<?php echo e(asset($item->post_image)); ?>" data-src="images/img8.jpg" alt="Card image cap">
                </a>
                <div class="course-badge-labels">
                    <div class="course-badge"><?php echo e($item->created_at->format('M d Y')); ?></div>
                </div>
            </div><!-- end card-image -->
            <div class="card-body">
...
<?php echo $__env->make('frontend.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\lms\lms\resources\views/frontend/blog/blog_list.blade.php ENDPATH**/ ?>