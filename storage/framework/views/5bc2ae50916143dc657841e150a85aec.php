...
unset($__errorArgs, $__bag); ?>" id="inputEmailAddress" placeholder="jhon@example.com">
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="col-12">
                ...
                <div class="input-group" id="show_hide_password">
                    <input type="password" name="password" id="password" class="form-control border-end-0 <?php $__errorArgs = ['password'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" placeholder="Enter Password"> <a href="javascript:;" class="input-group-text bg-transparent"><i class="bx bx-hide"></i></a>
...
</html><?php /**PATH C:\xampp\htdocs\lms\lms\resources\views/instructor/instructor_login.blade.php ENDPATH**/ ?>