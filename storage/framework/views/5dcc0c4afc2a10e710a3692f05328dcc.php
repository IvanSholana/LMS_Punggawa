...
<div class="page-content">
    ...
    <div class="card">
        <div class="card-body p-4">
            ...
            <form id="myForm" action="<?php echo e(route('store.course')); ?>" method="post" class="row g-3" enctype="multipart/form-data">
                <?php echo csrf_field(); ?>
                ...
                <div class="col-md-6"> 
                    <img id="showImage" src="<?php echo e(url('upload/no_image.jpg')); ?>" alt="Admin" class="rounded-circle p-1 bg-primary" width="100">  
                </div>
...
<?php echo $__env->make('instructor.instructor_dashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\lms\lms\resources\views/instructor/courses/add_course.blade.php ENDPATH**/ ?>