...
<?php echo e($blog->post_title); ?> | Easy Learning
    ...
    <div class="container">
        <div class="breadcrumb-content">
            <div class="section-heading pb-3">
                <h2 class="section__title"> <?php echo e($blog->post_title); ?></h2>
            </div>
            <ul class="generic-list-item generic-list-item-arrow d-flex flex-wrap align-items-center">
                <li><a href="index.html">Home</a></li>
                <li><a href="blog-no-sidebar.html">Blog</a></li>
                <li><?php echo e($blog->post_title); ?></li>
            </ul>
            <ul class="generic-list-item generic-list-item-bullet generic-list-item--bullet d-flex align-items-center flex-wrap fs-14 pt-2">
                <li class="d-flex align-items-center">By<a href="#">Admin</a></li>
                <li class="d-flex align-items-center"> <?php echo e($blog->created_at->format('M d Y')); ?> </li>
        ...
        <div class="row">
            <div class="col-lg-8 mb-5">
                <div class="card card-item">
                    <div class="card-body">
                        <p class="card-text pb-3"> <?php echo $blog->long_descp; ?> </p>
                        ...
                        <div class="d-flex flex-wrap justify-content-between align-items-center pt-3">
                            <ul class="generic-list-item generic-list-item-boxed d-flex flex-wrap fs-15">
                                ...
                                <li class="mr-2"><a href="#"><?php echo e(ucwords($tag)); ?></a></li>
                ...
                <div class="sidebar">
                    ...
                    <div class="card card-item">
                        <div class="card-body">
                            ...
                            <ul class="generic-list-item">
                                ...
                                <li><a href="<?php echo e(url('blog/cat/list/'.$cat->id)); ?>"><?php echo e($cat->category_name); ?></a></li>
                    ...
                    <div class="card card-item">
                        <div class="card-body">
                           ...
                           <?php $__currentLoopData = $post; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $dpost): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="media media-card border-bottom border-bottom-gray pb-4 mb-4">
                                <a href="<?php echo e(url('blog/details/'.$dpost->post_slug)); ?>" class="media-img">
                                    <img class="mr-3" src="<?php echo e(asset($dpost->post_image)); ?>" alt="Related course image">
                                </a>
                                <div class="media-body">
                                    <h5 class="fs-15"><a href="<?php echo e(url('blog/details/'.$dpost->post_slug)); ?>"><?php echo e($dpost->post_title); ?></a></h5>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('frontend.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\lms\lms\resources\views/frontend/blog/blog_details.blade.php ENDPATH**/ ?>