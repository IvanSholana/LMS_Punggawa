...
<p><strong>Hell Sir </strong><br/><strong>Your Request is confirm on this data. </strong></p>
        ...
        <h3>Invoice : <?php echo e($order['invoice_no']); ?></h3>
        <h3>Amount : <?php echo e($order['amount']); ?></h3>
        <h3>Name : <?php echo e($order['name']); ?></h3>
        <h3>Email : <?php echo e($order['email']); ?></h3>
...
</html><?php /**PATH C:\xampp\htdocs\lms\lms\resources\views/mail/order_mail.blade.php ENDPATH**/ ?>